...
@section('content')
    ...
    <div class="card w-75">
        <div class="container">
            <div class="col-lg-8">
                <form method="post" action="{{ route('agenda.store') }}" class="mb-5"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" id="slug" placeholder="Slug anda"
                            class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" readonly>
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="agenda" type="hidden" name="agenda" value="{{ old('agenda') }}">
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-success form-control">Tambah Agenda</button>
                    </div>
                </form>
            </div>
        </div>
